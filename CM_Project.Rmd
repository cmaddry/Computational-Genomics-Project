...
```{Finding the genes that are significant in both datasets, but also decreased less than 2x the initial starting point}
...
```{Computation across the frequency}
